            ...
            if safe_globals_to_add:
                try:
                    try:
                        ...
                        print("Setup Assistant (Final TTS) Warning: add_safe_globals not found in torch.serialization. This is expected for PyTorch < 2.1. XTTS models might still fail to load if this utility is missing.")
